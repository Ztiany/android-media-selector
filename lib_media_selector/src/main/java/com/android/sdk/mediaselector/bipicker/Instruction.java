...
public class Instruction implements Parcelable {
    ...
    public Instruction crop(CropOptions cropOptions) {
        ...
        notSupportForMultiSelecting("cropping");
    ...
    public Instruction multiple(boolean multiple) {
        notSupportForCamera("taking more than 1  items");
    ...
    private void notSupportForMultiSelecting(String action) {
        if (mIsMultiple) {
            throw new UnsupportedOperationException(action + " is not supported when taking more than one items.");
        }
    }
